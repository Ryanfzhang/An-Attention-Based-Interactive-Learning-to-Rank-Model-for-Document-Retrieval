...
class ArgsUtil(object):
    ...
    def ini_l2r_args(self, given_root=None):
        ...
        self.args_parser.add_argument('-model', type=str, default='attRNN', help='model')
        self.args_parser.add_argument('-epoch',type=int,default=200,help='the specific learning-to-rank framework.')
        ...
        self.args_parser.add_argument('-num_layers',type=int,default=1,help='the specific learning-to-rank framework.')
        self.args_parser.add_argument('-lr',type=float,default=0.001,help='the specific learning-to-rank framework.')
        self.args_parser.add_argument('-weight_decay',type=float,default=0.0005,help='the specific learning-to-rank framework.')
        self.args_parser.add_argument('-discount',type=float,default=0.93,help='the specific learning-to-rank framework.')
        self.args_parser.add_argument('-discount_pagewise',type=float,default=0.93,help='the specific learning-to-rank framework.')
        ...
        self.args_parser.add_argument('-n_head', type=int, default=1, help='multi head')
        self.args_parser.add_argument('-page',type= int, default=3,help="page size")
